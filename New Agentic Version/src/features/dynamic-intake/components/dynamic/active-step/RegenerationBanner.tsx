  ...
  return (
    <div className="ml-14 mb-4 p-4 bg-amber-50 dark:bg-amber-900/10 border-l-4 border-amber-500 rounded-r-lg shadow-sm animate-fade-in">
        <div className="flex justify-between items-center">
            <div>
                <h4 className="text-sm font-bold text-amber-800 dark:text-amber-400 uppercase tracking-wide flex items-center gap-2">
                    <Lock className="w-3 h-3" /> Regeneration Mode
                </h4>
            ...
            <div className="flex gap-2">
                <button 
                    onClick={onCancel}
                    className="px-3 py-1.5 text-xs font-bold text-zinc-500 hover:text-zinc-700 bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded hover:bg-zinc-50 transition-colors"
                >
                    Cancel
                </button>
                <button 
